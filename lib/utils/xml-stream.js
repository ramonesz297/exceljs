...
class XmlStream {
  ...
  _flush = () => {
    ...
    for (let i = this._flushIndex; i < this._chanks.length; i++) {
    ...
    // The current bucket can still receive data; rollback never crosses flushed buckets.
    this._flushIndex = this._chanks.length - 1;
  };
